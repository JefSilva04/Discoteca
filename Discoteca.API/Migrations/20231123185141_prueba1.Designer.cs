...
namespace Discoteca.API.Migrations
{
    ...
    [Migration("20231123185141_prueba1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Discoteca.Shared.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Discoteca.Shared.Entities.Attention", b =>
                {
                    ...
                    b.HasOne("Discoteca.Shared.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Discoteca.Shared.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
